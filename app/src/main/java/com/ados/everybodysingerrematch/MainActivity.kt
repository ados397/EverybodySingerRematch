...
import com.ados.everybodysingerrematch.dialog.NoticeDialog
...
import com.ados.everybodysingerrematch.page.FragmentPageCheering
import com.ados.everybodysingerrematch.page.FragmentPageMusic
import com.ados.everybodysingerrematch.page.FragmentPageRank
import com.ados.everybodysingerrematch.page.FragmentPageVote
    ...
    fun adviewVisible() {
        when(adType) {
            ...
            getString(R.string.adtype_adfit) -> {
                ...
                adView_kakao.setClientId("DAN-U6IraHWngRlaqTr8")  // 할당 받은 광고 단위(clientId) 설정
